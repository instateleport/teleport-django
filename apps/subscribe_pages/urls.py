...
urlpatterns = [
    # API
     ...
     path('tg-subscribe-page/delete/', views.TGSubscribePageDeleteView.as_view(),
          name='page-delete'),
     path('tg-subscribe-page/<slug:slug>/duplicate/',
          views.TGSubscribePageDuplicateView.as_view(), name='tg-page-duplicate'),
     path('tg-subscribe-page/<slug:slug>/',
          views.TGSubscribePageDetailView.as_view(), name='tg-page-detail'),
     path('tg-subscribe-page/<slug:slug>/statistic/',
          views.TGStatisticSubscribePageDetailView.as_view(),
          name='tg-page-statistic'),
     path('tg-subscribe-page/<slug:slug>/statistic/get-tg-statistic/',
          views.TGStatisticAjaxView.as_view(),
          name='tg-ajax-page-statistic'),
     path('tg-subscribe-page/<slug:slug>/statistic/download-tg-subscribers/',
          views.TGStatisticSubscribePageDownloadSubscribers.as_view(),
          name='tg-page-statistic-download-subscribers'),
     path('tg-page/<slug:slug>/', views.TGSubscribePageOpenView.as_view(),
          name='tg-page-open'),
